...
const char* const FACE_DETECTION_CONFIGURATION = "assets/deploy.prototxt.txt";

const char* const FACE_DETECTION_WEIGHTS = "assets/res10_300x300_ssd_iter_140000_fp16.caffemodel";

FaceDetector::FaceDetector(): input_image_width_(300), input_image_height_(300), scale_factor_(1.0),
mean_values_({ 104., 177.0, 123.0 }), confidence_threshold_(0.5)
{
